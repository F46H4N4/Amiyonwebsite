...
const BreadcrumbTwelve = () => {
   ...
   return (
      <div
         style={{
            backgroundImage: `url(/assets/img/contact/contact-bannerthree.png)`,
      ...
      >
        <div className="breadcrumb__content z-index-3 text-center">
                           <h3 ref={animeRef} className="breadcrumb__title tp-char-animation text-black anime_text" style={{ color:'white !important',fontSize:'70px !important' }}>Get In Touch</h3>
