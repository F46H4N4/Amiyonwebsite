...
const BreadcrumbEleven = () => {
   const { animeRef } = useBreadcrumbTitleAnime();

   return (
      <div
         style={{
            backgroundImage: `url('/assets/img/about/aboutimage.png')`,
      ...
      >
        <div className="breadcrumb__content z-index-3 text-center">
                           <h3 ref={animeRef} className="breadcrumb__title tp-char-animation text-black anime_text" style={{ color:'white !important',fontSize:'70px !important' }}>About Us</h3>
...
export default BreadcrumbEleven;