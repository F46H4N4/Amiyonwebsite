...
const cta_content  ={
    ...
    des: <>Amiyon started over 10 years ago with the goal of making technology accessible to everyone. From a small startup, we've grown into a trusted partner for businesses seeking innovative digital solutions. We create websites, apps, and custom business tools, always focused on helping our clients succeed. Our startup spirit remains strong agile and customer centered.   <br /></>,
    feature_list: [
        "Billable",
        "Manual time entries",
        "Services",
