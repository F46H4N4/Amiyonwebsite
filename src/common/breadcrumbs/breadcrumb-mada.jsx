...
const BreadcrumbEight = () => {
   ...
   const text = "Madaeats: Personalized, allergen-free meals delivered to your door for a healthier lifestyle!";
   ...
   return (
      <>
         ...
         >
            ...
            >
               <source src="/assets/diet.mp4" type="video/mp4" />
            ...
            <div className="container">
               ...
               <Link href="https://madaeats.com/admin/"
                   style={{
                  color: '#ffffff',
                  fontWeight: 'bold',
                  textDecoration: 'none',
