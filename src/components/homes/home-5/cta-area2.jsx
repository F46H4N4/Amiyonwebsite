...
import plan_img_1 from "../../../../public/assets/img/about/aboutblock.png"
...
const cta_content  ={
    ...
    des: <>At Amiyon, we empower businesses with innovative digital solutions that drive growth and improve efficiency. Our customized services bridge the gap between technology and business needs, helping to turn ideas into reality. Through creativity and collaboration, we support businesses in thriving in the digital era.<br /></>,
    feature_list: [
        "Billable",
        "Manual time entries",
        "Services",
