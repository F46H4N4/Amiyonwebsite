...
const portfolio_data = [    
    {
        ...
        job_title: "WEB APPLICATION",
        title: <></>,
        des: <>Seamless,<br></br>data-driven web apps.</>,
        delay: ".5s",
    ...
    }, 
    {
        ...
        job_title: "WEB HOSTING",
        title: <></>,
        des: <>Reliable, fast web hosting with 99.9% uptime.</>,
        delay: ".5s",
        category: "Branding",
        filter_id: ["all", "Design Work", "Branding", "Development", "Illusutration", "App Design" ],
    }, 
    {
        ...
        job_title: "OUTSOURCING SERVICES",
        // title: <>GoPaynet</>,
        des: <>All-in-one IT outsourcing solutions.</>,
        delay: ".5s",
        category: "Design Work",
        filter_id: ["all", "Design Work", "Branding", "Development", "Illusutration", "App Design" ],
    }, 
    {
        ...
        job_title: "MOBILE DEVELOPMENT",
        // title: <>Yalfish</>,
        des: <>Mobile app development for iOS and Android.</>,
        delay: ".5s",
    ...
    }, 
    {
        ...
        job_title: "BUSINESS",
        // title: <>Omahat</>,
        des: <>Adaptive tech solutions for manufacturing and retail.</>,
        delay: ".5s",
    ...
    }, 
    {
        ...
        job_title: "COMMERCE",
        // title: <>Al Durra</>,
        des: <>End-to-end e-commerce solutions for B2B and B2C.</>,
        delay: ".5s",
        category: "Design Work",
        filter_id: ["all", "Design Work", "Branding", "Development", "Illusutration", "App Design" ],
    }, 
    {
        ...
        job_title: "QUALITY ASSURANCE & TESTING",
        // title: <>Funtech</>,
        des: <>Mobile app development for iOS and Android.</>,
        delay: ".5s",
        category: "App Design",
