...
const BreadcrumbEight = () => {
   ...
   const text = "Kuwait's top online store for essentials, household items, and eco-friendly products with 24/7 service and trusted quality.";
   ...
   return (
      <>
         ...
         >
            ...
            >
               <source src="/assets/akyasnew.mp4" type="video/mp4" />
