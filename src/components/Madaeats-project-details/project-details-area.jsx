...
const project_details_data = [
    {
        ...
        description: (
            <>
                **Madaeats** is a food delivery platform tailored for individuals with specific dietary needs and food allergies. It allows users to customize their meals by excluding foods that may cause allergic reactions, ensuring a safe and healthy dining experience.
                <br /><br />
    ...
    },
    {
        ...
        description: (
            <>
                **Madaeats** provides the following key features:
                <br /><br />
...
const project_details_content = { 
    ...
    des_1: (
        <>
            **Madaeats** was developed with the goal of providing a safe and convenient meal delivery service for those with dietary restrictions and food allergies. By allowing users to customize their meals and exclude allergens, Madaeats ensures a worry-free eating experience.
            <br /><br />
