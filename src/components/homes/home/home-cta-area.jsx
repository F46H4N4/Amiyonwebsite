...
const cta_content  ={
    ...
    title: <><span>Your Trusted IT Solutions <br></br>Partner</span></>,
    des: <>Amiyon Solutions is a trusted provider of IT services with extensive market experience and a personalized approach. We deliver high-quality products and services while exceeding expectations and staying within budget. Our commitment to exceptional service and a customer-centric focus drives success through tailored IT solutions.<br /></>,
    feature_list: [
        "Billable",
        "Manual time entries",
        "Services",
...
const CtaArea = () => {
    return (
        <>
            <div className="tp-plan-area tp-plan-space " style={{ background: 'white', paddingTop: '74px', width: '100%', paddingBottom:'74px'}}>
