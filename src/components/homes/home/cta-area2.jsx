...
import plan_img_1 from "../../../../public/assets/img/feature/smilingfaces.png"
...
const cta_content  ={
    ...
    title: <><span>Amiyon Your Complete Solution Partner.</span></>,
    des: <> We believe in a personalized approach,
        understanding that each customer and project is unique, and this is where our expertise truly shines.<br /></>,
    feature_list: [
        "Billable",
        "Manual time entries",
        "Services",
...
const CtaArea = () => {
    return (
        <>
            <div className= "tp-plan-area tp-plan-space" style={{ background :'white',paddingTop:"74px" }}>
